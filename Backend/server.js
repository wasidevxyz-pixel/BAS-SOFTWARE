...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://static.cloudflareinsights.com", "https://code.jquery.com"],
...
// Set static folder for all public assets (including HTML, CSS, JS) with NO CACHE
...
app.get('/bank-ledger.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'bank-ledger.html'));
});
...
app.get('/units.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'units.html'));
});
...
app.get('/sales-returns.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'sale-returns.html'));
});

app.get('/purchase-returns.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'purchase-returns.html'));
});

app.get('/cash-transactions.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'cash-transactions.html'));
});

app.get('/bank-transactions.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'bank-transactions.html'));
});

app.get('/daybook.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'daybook.html'));
});
...
app.get('/account-groups.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'account-groups.html'));
});

app.get('/account-categories.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'account-categories.html'));
});
...
app.get('/banks.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'banks.html'));
});

app.get('/customer-demand.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'customer-demand.html'));
});
...
app.get('/attendance-list.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'attendance-list.html'));
});

app.get('/import-attendance.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'import-attendance.html'));
});
...
app.get('/attendance-add.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'attendance-add.html'));
});

app.get('/employee-advance.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-advance.html'));
});
...
app.get('/holy-days.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'holy-days.html'));
});

app.get('/wht-supplier.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wht-supplier.html'));
});

app.get('/employee-commission.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-commission.html'));
});

app.get('/employee-sale-commission.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-sale-commission.html'));
});
...
app.get('/employee-penalty.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-penalty.html'));
});

app.get('/employee-clearance.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-clearance.html'));
});

app.get('/employee-adjustment.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-adjustment.html'));
});

app.get('/wh-supplier.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-supplier.html'));
});

app.get('/wh-customer.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-customer.html'));
});

app.get('/wh-purchase.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-purchase.html'));
});

app.get('/wh-purchase-return.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-purchase-return.html'));
});

app.get('/wh-sale.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-sale.html'));
});

app.get('/wh-sale-return.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-sale-return.html'));
});

app.get('/wh-stock-audit.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-stock-audit.html'));
});

app.get('/wh-customer-payment.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'wh-customer-payment.html'));
});

app.get('/commission-item.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'commission-item.html'));
});



app.get('/print-invoice.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'print-invoice.html'));
});

app.get('/voucher-print.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'voucher-print.html'));
});

app.get('/print-payroll.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'print-payroll.html'));
});

app.get('/employee-salary-detail-report.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'employee-salary-detail-report.html'));
});

app.get('/bank-paid-salary-report.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public', 'bank-paid-salary-report.html'));
});
